---
title:  "컴포넌트 템플릿 범위와 v-for"
excerpt: "Vue.js의 컴포넌트 템플릿 범위와 v-for의 관계"
...
_해결 방법으로 바로 가고싶으시다면 [여기](https://yulsanoh.github.io/vue.js/vuejs-vfor-template-error/#%EB%8D%B0%EC%9D%B4%ED%84%B0-%EB%B0%94%EC%9D%B8%EB%94%A9%EA%B3%BC-v-for%EB%AC%B8)를 클릭해주세요_

Vue.js를 통해 컴포넌트를 만들어서 해당 컴포넌트 내에 데이터를 보내줄 때는 데이터를 어디에 받냐에 따라서 쓰는 `v-bind`를 바인딩 하는 방법이 달라지게 되는데 매우 기초적일 수 있으나 이해하기 위해 정리하기 위해 작성하는 포스트입니다. __무조건 정답이 아닌 포스트이니 주의 바랍니다!__
